...
MIDDLEWARE = [
    ...
    'students.middleware.JWTAuthenticationMiddleware',  # Add this line
    'students.middleware_messaging.JWTUserMiddleware',  # Add messaging middleware
]
...
MEDIA_URL = '/fileCourses/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'fileCourses')
